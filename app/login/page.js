    ...
    return (
        <div>
            <div className='text-white py-8 container mx-auto'>
                <h1 className=' text-3xl font-bold text-center'>Login/Signup to get your fans to support you</h1>
            </div>
            <div className="flex flex-col justify-center items-center gap-2  p-10">
                ...
                <button
                    ...
                    className="flex items-center w-64 text-black bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium   hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                ...
                <Link href={"/loginpage"}> <button
                    
                    className="flex items-center w-64 text-black bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium   hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                    
                    <span>want to create a temporary account </span>
                </button>
                </Link>
